...
class TensorflowJobBuilder(JobBuilder):
    ...
    def with_worker_selectors(self,selectors: Dict[str,str]) -> TensorflowJobBuilder:
        self._options.append(StringMapField("--worker-selector",selectors,"="))
        return self

    def with_worker_port(self,port: int) -> TensorflowJobBuilder:
        self._options.append(StringField("--worker-port",str(port)))
        return self

    def with_worker_memory(self,memory: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--worker-memory",memory))
        return self

    def with_worker_image(self,image: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--worker-image",image))
        return self

    def with_worker_cpu(self,cpu: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--worker-cpu",cpu))
        return self

    def with_ps_selectors(self,selectors: Dict[str,str]) -> TensorflowJobBuilder:
        self._options.append(StringMapField("--ps-selector",selectors,"="))
        return self
    
    def with_ps_port(self,port: int) -> TensorflowJobBuilder:
        self._options.append(StringField("--ps-port",str(port)))
        return self

    def with_ps_memory(self,memory: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--ps-memory",memory))
        return self

    def with_ps_image(self,image: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--ps-image",image))
        return self

    def with_ps_cpu(self,cpu: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--ps-cpu",cpu))
        return self

    def with_ps_count(self,count: int) -> TensorflowJobBuilder:
        self._options.append(StringField("--ps",str(count)))
        return self

    def with_evaluator_selector(self,selectors: Dict[str,str]) -> TensorflowJobBuilder:
        self._options.append(StringMapField("--evaluator-selector",selectors))
        return self

    def with_evaluator_memory(self,memory: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--evaluator-memory",memory))
        return self

    def with_evaluator_cpu(self,cpu: str) -> TensorflowJobBuilder:
        self._options.append(StringField("--evaluator-cpu",cpu))
        return self

    def with_enable_evaluator(self) -> TensorflowJobBuilder:
        self._options.append(BoolField("--evaluator"))
        return self

    def with_chief_selectors(self, selectors: Dict[str,str]) -> TensorflowJobBuilder:
