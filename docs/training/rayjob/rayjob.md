...
- `--entrypoint` Specify the command to be executed when submitting Ray job. (required)
- `--head-cpu` The cpu resource of Ray head pod for the training, like `1` for 1 core. (default: `1`)
- `--head-memory` The memory resource of Ray head pod for the training, like `2Gi`. (default: `2Gi`)
- `--worker-cpu` The cpu resource of Ray worker pod for the training, like `1` for 1 core. (default: `1`)
- `--worker-memory` The memory resource of Ray worker pod for the training, like `1Gi`. (default: `1Gi`)
