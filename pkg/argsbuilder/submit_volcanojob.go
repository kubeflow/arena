...
func (s *SubmitVolcanoJobArgsBuilder) AddCommandFlags(command *cobra.Command) {
	...
	_ = command.Flags().MarkDeprecated("minAvailable", "please use --min-available instead")
	...
	_ = command.Flags().MarkDeprecated("schedulerName", "please use --scheduler-name instead")
	...
	_ = command.Flags().MarkDeprecated("taskName", "please use --task-name instead")
	...
	_ = command.Flags().MarkDeprecated("taskImages", "please use --task-images instead")
	...
	_ = command.Flags().MarkDeprecated("taskReplicas", "please use --task-replicas instead")
	...
	_ = command.Flags().MarkDeprecated("taskCPU", "please use --task-cpu instead")
	...
	_ = command.Flags().MarkDeprecated("taskMemory", "please use --task-memory instead")
	...
	_ = command.Flags().MarkDeprecated("taskPort", "please use --task-port instead")
