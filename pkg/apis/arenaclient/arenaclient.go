...
// four args are needed:
// 1.kubeconfig: assign the kubeconfig file
// 2.namespace: assign the default namespace
// 3.arenaSystemNamespace: assign the arena system namespace
// 4.logLevel: assign the log level
