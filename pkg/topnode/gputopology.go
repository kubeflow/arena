...
func (g *gputopo) getTotalGPUs() float64 {
...
func (g *gputopo) getAllocatedGPUs() float64 {
	allocatedGPUs := 0
...
func displayGPUTopologyNodeSummary(w *tabwriter.Writer, nodes []Node, isUnhealthy, showNodeType bool) (float64, float64, float64) {
	totalGPUs := float64(0)
