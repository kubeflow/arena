...
func (p *TensorFlowProvider) BuildCRD(t *task.Task) (*unstructured.Unstructured, error) {
	...
	workerSpec, err := buildRoleReplicaSpec(constants.FrameworkTensorFlow, t, t.Worker.Resources, t.Worker.Envs, int64(t.Worker.Replicas), restartPolicy, true)
	if err != nil {
	...
	if t.Chief != nil {
		chiefSpec, err := buildRoleReplicaSpec(constants.FrameworkTensorFlow, t, t.Chief.Resources, t.Chief.Envs, 1, restartPolicy, true)
		if err != nil {
	...
	if t.PS != nil {
		psSpec, err := buildRoleReplicaSpec(constants.FrameworkTensorFlow, t, t.PS.Resources, t.PS.Envs, int64(t.PS.Replicas), restartPolicy, true)
		if err != nil {
	...
	if t.Evaluator != nil {
		evalSpec, err := buildRoleReplicaSpec(constants.FrameworkTensorFlow, t, t.Evaluator.Resources, t.Evaluator.Envs, 1, restartPolicy, true)
		if err != nil {
