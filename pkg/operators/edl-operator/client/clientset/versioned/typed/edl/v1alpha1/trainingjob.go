...
import (
	...
	scheme "github.com/kubeflow/arena/pkg/operators/edl-operator/client/clientset/versioned/scheme"
...
func newTrainingJobs(c *EdlV1alpha1Client, namespace string) *trainingJobs {
	return &trainingJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
