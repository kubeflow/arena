...
import (
	"github.com/kubeflow/arena/pkg/operators/edl-operator/api/common"
...
type TrainingJobSpec struct {
	...
	// `EDLReplicaSpecs` contains maps from `EDLReplicaType` to `ReplicaSpec` that
	// specify the EDL replicas to run.
	EDLReplicaSpecs EDLReplicaSpecs `json:"edlReplicaSpecs"`
...
type EDLReplicaSpecs struct {
	Launcher *common.ReplicaSpec `json:"Launcher"`
	Worker   *EDLReplicaSpec     `json:"Worker"`
}

type EDLReplicaSpec struct {
...
// EDLReplicaType is the type for EDLReplica.
type EDLReplicaType common.ReplicaType

const (
	// EDLReplicaTypeLauncher is the type for launcher replica.
	EDLReplicaTypeLauncher EDLReplicaType = "Launcher"

	// EDLReplicaTypeWorker is the type for worker replicas.
	EDLReplicaTypeWorker EDLReplicaType = "Worker"
)
