...
func SetDefaults_MPIJob(mpiJob *MPIJob) {
	...
	setDefaultsTypeLauncher(mpiJob.Spec.MPIReplicaSpecs[common.MPIJobReplicaTypeLauncher])

	// set default to Worker
	setDefaultsTypeWorker(mpiJob.Spec.MPIReplicaSpecs[common.MPIJobReplicaTypeWorker])
}
