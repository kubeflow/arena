...
import (
	...
	kubeflowv1 "github.com/kubeflow/arena/pkg/operators/mpi-operator/apis/kubeflow/v1"
...
func (c *FakeMPIJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubeflowv1.MPIJob, err error) {
	...
	return obj.(*kubeflowv1.MPIJob), err
}
...
func (c *FakeMPIJobs) List(ctx context.Context, opts v1.ListOptions) (result *kubeflowv1.MPIJobList, err error) {
	...
	list := &kubeflowv1.MPIJobList{ListMeta: obj.(*kubeflowv1.MPIJobList).ListMeta}
	for _, item := range obj.(*kubeflowv1.MPIJobList).Items {
