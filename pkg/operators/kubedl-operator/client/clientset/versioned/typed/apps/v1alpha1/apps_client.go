...
import (
	...
	"github.com/kubeflow/arena/pkg/operators/kubedl-operator/client/clientset/versioned/scheme"
...
func (c *AppsV1alpha1Client) Crons(namespace string) CronInterface {
	return newCrons(c, namespace)
}
