...
import (
	constants "github.com/kubeflow/arena/pkg/operators/kserve-operator/constants"
...
func (in *InferenceServicesConfig) DeepCopyInto(out *InferenceServicesConfig) {
	*out = *in
	out.Transformers = in.Transformers
	in.Predictors.DeepCopyInto(&out.Predictors)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PredictorProtocols) DeepCopyInto(out *PredictorProtocols) {
	*out = *in
	if in.V1 != nil {
		in, out := &in.V1, &out.V1
		*out = new(PredictorConfig)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PredictorProtocols.
func (in *PredictorProtocols) DeepCopy() *PredictorProtocols {
	if in == nil {
		return nil
	}
	out := new(PredictorProtocols)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictorsConfig) DeepCopyInto(out *PredictorsConfig) {
	*out = *in
	...
	in.PMML.DeepCopyInto(&out.PMML)
	in.LightGBM.DeepCopyInto(&out.LightGBM)
	in.Paddle.DeepCopyInto(&out.Paddle)
	return
}
