...
func NewSubmitDistributedServingJobCommand() *cobra.Command {
	builder := serving.NewDistributedServingJobBuilder()
	var command = &cobra.Command{
		Use:     "distributed",
		Short:   "Submit distributed server job to deploy and serve machine learning models.",
		Aliases: []string{"distributed"},
