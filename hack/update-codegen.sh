...
ROOT_PKG=github.com/kubeflow/arena
...
${CODEGEN_PKG}/generate-groups.sh "all" \
    github.com/kubeflow/arena/pkg/operators/training-operator/client github.com/kubeflow/arena/pkg/operators/training-operator/apis \
    kubeflow.org:v1 \
...
${GOPATH}/bin/defaulter-gen --input-dirs github.com/kubeflow/arena/pkg/operators/training-operator/apis/kubeflow.org/v1 \
    -O zz_generated.defaults \
    --output-package github.com/kubeflow/arena/pkg/operators/training-operator/apis/kubeflow.org/v1 \
    --go-header-file hack/boilerplate/boilerplate.go.txt "$@" \
    --output-base "${TEMP_DIR}"
...
go build -o openapi-gen -mod mod ${OPENAPI_PKG}/cmd/openapi-gen

echo "Generating OpenAPI specification for kubeflow.org/v1"
./openapi-gen --input-dirs github.com/kubeflow/arena/pkg/operators/training-operator/apis/kubeflow.org/v1,github.com/kubeflow/common/pkg/apis/common/v1 \
