...
func (c *FakeMPIJobs) List(opts v1.ListOptions) (result *v1alpha2.MPIJobList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Create(mPIJob *v1alpha2.MPIJob) (result *v1alpha2.MPIJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Update(mPIJob *v1alpha2.MPIJob) (result *v1alpha2.MPIJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) UpdateStatus(mPIJob *v1alpha2.MPIJob) (*v1alpha2.MPIJob, error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.MPIJob, err error) {
	obj, err := c.Fake.
