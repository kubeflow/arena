...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobCondition": {
			Schema: spec.Schema{
		...
		"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
						...
						"conditions": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobCondition"),
										},
									},
								},
							},
						...
						"replicaStatuses": {
							SchemaProps: spec.SchemaProps{
								...
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.ReplicaStatus"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobCondition", "github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.ReplicaStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
		},
		"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.ReplicaSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.ReplicaStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"github.com/kubeflow/pytorch-operator/pkg/apis/pytorch/v1.PyTorchJob": {
					...
					Properties: map[string]spec.Schema{
						...
						"status": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.JobStatus", "github.com/kubeflow/pytorch-operator/pkg/apis/pytorch/v1.PyTorchJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
						...
						"pytorchReplicaSpecs": {
							SchemaProps: spec.SchemaProps{
								...
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/arena/dependency/operators/tf-operator/apis/common/v1.ReplicaSpec"),
										},
									},
								},
							},
