...
// List lists all PyTorchJobs in the indexer.
func (s *pyTorchJobLister) List(selector labels.Selector) (ret []*v1beta2.PyTorchJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.PyTorchJob))
	})
	return ret, err
}
...
// List lists all PyTorchJobs in the indexer for a given namespace.
func (s pyTorchJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.PyTorchJob, err error) {
...
// Get retrieves the PyTorchJob from the indexer for a given namespace and name.
func (s pyTorchJobNamespaceLister) Get(name string) (*v1beta2.PyTorchJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("pytorchjob"), name)
	}
	return obj.(*v1beta2.PyTorchJob), nil
}
