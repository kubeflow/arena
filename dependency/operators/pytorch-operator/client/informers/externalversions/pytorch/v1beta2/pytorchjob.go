...
import (
	...
	v1beta2 "github.com/kubeflow/pytorch-operator/pkg/client/listers/pytorch/v1beta2"
...
type PyTorchJobInformer interface {
	...
	Lister() v1beta2.PyTorchJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeflowV1beta2().PyTorchJobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeflowV1beta2().PyTorchJobs(namespace).Watch(options)
			},
		},
		&pytorchv1beta2.PyTorchJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pyTorchJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pytorchv1beta2.PyTorchJob{}, f.defaultInformer)
}

func (f *pyTorchJobInformer) Lister() v1beta2.PyTorchJobLister {
	return v1beta2.NewPyTorchJobLister(f.Informer().GetIndexer())
}
