...
import (
	...
	scheme "github.com/kubeflow/arena/cmd/arena/commands/mpi/client/clientset/versioned/scheme"
...
type MPIJobInterface interface {
	Create(*v1alpha2.MPIJob) (*v1alpha2.MPIJob, error)
	Update(*v1alpha2.MPIJob) (*v1alpha2.MPIJob, error)
	UpdateStatus(*v1alpha2.MPIJob) (*v1alpha2.MPIJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.MPIJob, error)
	List(opts v1.ListOptions) (*v1alpha2.MPIJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.MPIJob, err error)
	MPIJobExpansion
}
...
func (c *mPIJobs) Get(name string, options v1.GetOptions) (result *v1alpha2.MPIJob, err error) {
...
func (c *mPIJobs) List(opts v1.ListOptions) (result *v1alpha2.MPIJobList, err error) {
...
func (c *mPIJobs) Create(mPIJob *v1alpha2.MPIJob) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Update(mPIJob *v1alpha2.MPIJob) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) UpdateStatus(mPIJob *v1alpha2.MPIJob) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
