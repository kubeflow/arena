...
import (
	...
	"github.com/kubeflow/arena/dependency/operators/spark-operator/apis/sparkoperator.k8s.io/v1beta1"
	"github.com/kubeflow/arena/dependency/operators/spark-operator/client/clientset/versioned"
