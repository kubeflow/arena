...
func (sj *StandaloneJob) GetTrainingJobResources(client *kubernetes.Clientset, jobName string) TrainingJobResources {
...
func (sj *StandaloneJob) GetPodsOfJob(client *kubernetes.Clientset, jobName string) *v1.PodList {
	pods, err := client.CoreV1().Pods(namespace).List(metav1.ListOptions{
		TypeMeta: metav1.TypeMeta{
			Kind:       "ListOptions",
			APIVersion: "v1",
		}, LabelSelector: fmt.Sprintf("release=%s,app=standalonejob", jobName),
	})
	if err != nil {
